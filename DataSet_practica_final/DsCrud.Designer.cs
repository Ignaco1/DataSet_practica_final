...
namespace DataSet_practica_final {
    ...
    public partial class DsCrud : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsuariosRow AddUsuariosRow(string Nombre, string Correo, System.DateTime Fecha_de_nacimiento, int Edad) {
        ...
        public partial class UsuariosRow : global::System.Data.DataRow {
            ...
            public System.DateTime Fecha_de_nacimiento {
                get {
                    return ((global::System.DateTime)(this[this.tableUsuarios.Fecha_de_nacimientoColumn]));
                }
                set {
                    this[this.tableUsuarios.Fecha_de_nacimientoColumn] = value;
                }
            }
...
namespace DataSet_practica_final.DsCrudTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Usuarios] WHERE (([Id] = @Original_Id) AND ([Nombre] = @Original_Nom" +
                "bre) AND ([Correo] = @Original_Correo) AND ([Fecha de nacimiento] = @Original_Fe" +
                "cha_de_nacimiento) AND ([Edad] = @Original_Edad))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Usuarios] ([Nombre], [Correo], [Fecha de nacimiento], [Edad]) VALUES" +
                " (@Nombre, @Correo, @Fecha_de_nacimiento, @Edad);\r\nSELECT Id, Nombre, Correo, [F" +
                "echa de nacimiento], Edad FROM Usuarios WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Usuarios] SET [Nombre] = @Nombre, [Correo] = @Correo, [Fecha de nacimiento] = @Fecha_de_nacimiento, [Edad] = @Edad WHERE (([Id] = @Original_Id) AND ([Nombre] = @Original_Nombre) AND ([Correo] = @Original_Correo) AND ([Fecha de nacimiento] = @Original_Fecha_de_nacimiento) AND ([Edad] = @Original_Edad));
SELECT Id, Nombre, Correo, [Fecha de nacimiento], Edad FROM Usuarios WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataSet_practica_final.Properties.Settings.Default.DB_PRACTICAConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "insert into Usuarios(Nombre, Correo, [Fecha de nacimiento], Edad) values(@nombre," +
                " @correo, @fecha_de_nacimiento, @edad)";
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@fecha_de_nacimiento", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "Fecha de nacimiento", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].CommandText = "delete from Usuarios where Id=@id";
            ...
            this._commandCollection[3].CommandText = "select * from Usuarios where Id=@id";
            ...
            this._commandCollection[4].CommandText = "update Usuarios set Nombre =@nombre, Correo =@correo, [Fecha de nacimiento] =@fec" +
                "ha_de_nacimiento, Edad =@edad WHERE Id =@id";
            ...
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@fecha_de_nacimiento", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "Fecha de nacimiento", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int Fill(DsCrud.UsuariosDataTable dataTable) {
        ...
        public virtual DsCrud.UsuariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DsCrud.UsuariosDataTable dataTable = new DsCrud.UsuariosDataTable();
        ...
        public virtual int FillBy(DsCrud.UsuariosDataTable dataTable, int id) {
        ...
        public virtual DsCrud.UsuariosDataTable GetPersona(int id) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(id));
            DsCrud.UsuariosDataTable dataTable = new DsCrud.UsuariosDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DsCrud.UsuariosDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Nombre, string Original_Correo, System.DateTime Original_Fecha_de_nacimiento, int Original_Edad) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((System.DateTime)(Original_Fecha_de_nacimiento));
        ...
        public virtual int Insert(string Nombre, string Correo, System.DateTime Fecha_de_nacimiento, int Edad) {
            if ((Nombre == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((System.DateTime)(Fecha_de_nacimiento));
        ...
        public virtual int Update(string Nombre, string Correo, System.DateTime Fecha_de_nacimiento, int Edad, int Original_Id, string Original_Nombre, string Original_Correo, System.DateTime Original_Fecha_de_nacimiento, int Original_Edad, int Id) {
            if ((Nombre == null)) {
                throw new global::System.ArgumentNullException("Nombre");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((System.DateTime)(Fecha_de_nacimiento));
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((System.DateTime)(Original_Fecha_de_nacimiento));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Correo, System.DateTime Fecha_de_nacimiento, int Edad, int Original_Id, string Original_Nombre, string Original_Correo, System.DateTime Original_Fecha_de_nacimiento, int Original_Edad) {
            return this.Update(Nombre, Correo, Fecha_de_nacimiento, Edad, Original_Id, Original_Nombre, Original_Correo, Original_Fecha_de_nacimiento, Original_Edad, Original_Id);
        }
        ...
        public virtual int Agregar(string nombre, string correo, System.DateTime fecha_de_nacimiento, int edad) {
            ...
            command.Parameters[2].Value = ((System.DateTime)(fecha_de_nacimiento));
        ...
        public virtual int Modificar(string nombre, string correo, System.DateTime fecha_de_nacimiento, int edad, int id) {
